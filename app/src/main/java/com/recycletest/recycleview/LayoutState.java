...
class LayoutState {
    ...
    /**
     * This is the target pixel closest to the start of the layout that we are trying to
     * fill
     */
    int mStartLine = 0;

    /**
     * This is the target pixel closest to the end of the layout that we are trying to
     * fill
     */
    int mEndLine = 0;
