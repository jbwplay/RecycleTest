...
/**
 * Implementation of the {@link SnapHelper} supporting snapping in either vertical or
 * horizontal orientation.
 * <p>
 * The implementation will snap the center of the target child view to the center of the
 * attached {@link RecyclerView}. If you intend to change this behavior then override
...
public class LinearSnapHelper extends SnapHelper {
    ...
    /**
     * Estimates a position to which SnapHelper will try to scroll to in response to a
     * fling.
     * @param layoutManager The {@link RecyclerView.LayoutManager} associated with the
     * attached {@link RecyclerView}.
     * @param helper The {@link OrientationHelper} that is created from the
     * LayoutManager.
     ...
     * @param layoutManager The {@link RecyclerView.LayoutManager} associated with the
     * attached {@link RecyclerView}.
     * @param helper The relevant {@link OrientationHelper} for the attached {@link
     * RecyclerView}.
     * @return the child view that is currently closest to the center of this parent.
     */
    @Nullable
     ...
     * @return A float value that is the average number of pixels needed to scroll by one
     * view in the relevant direction.
     */
