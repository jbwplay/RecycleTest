...
/**
 * Wraps a {@link com.recycletest.recycleview.util.ListUpdateCallback} callback and batches operations that can be merged.
 * <p>
 ...
 * <p>
 * This is a general purpose class and is also used by {@link com.recycletest.recycleview.util.DiffUtil.DiffResult
 * DiffResult} and {@link com.recycletest.recycleview.util.SortedList} to minimize the number of updates that are
 * dispatched.
 * <p>
 * If you use this class to batch updates, you must call {@link #dispatchLastEvent()} when
 * the stream of update events drain.
 */
public class BatchingListUpdateCallback implements com.recycletest.recycleview.util.ListUpdateCallback {
    private static final int TYPE_NONE = 0;
    private static final int TYPE_ADD = 1;
    private static final int TYPE_REMOVE = 2;
    private static final int TYPE_CHANGE = 3;

    final com.recycletest.recycleview.util.ListUpdateCallback mWrapped;
    ...
    public BatchingListUpdateCallback(com.recycletest.recycleview.util.ListUpdateCallback callback) {
        mWrapped = callback;
    }

    /**
     * BatchingListUpdateCallback holds onto the last event to see if it can be merged
     * with the next one. When stream of events finish, you should call this method to
     * dispatch the last event.
     */
