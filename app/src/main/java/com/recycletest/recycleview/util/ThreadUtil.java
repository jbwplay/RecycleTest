...
interface ThreadUtil<T> {
    ...
    interface MainThreadCallback<T> {
        ...
        void addTile(int generation, com.recycletest.recycleview.util.TileList.Tile<T> tile);
    ...
    interface BackgroundCallback<T> {
        ...
        void recycleTile(com.recycletest.recycleview.util.TileList.Tile<T> tile);
    }
