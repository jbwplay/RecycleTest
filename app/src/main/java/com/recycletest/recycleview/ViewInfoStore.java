...
import static com.recycletest.recycleview.ViewInfoStore.InfoRecord.FLAG_APPEAR;
import static com.recycletest.recycleview.ViewInfoStore.InfoRecord.FLAG_APPEAR_AND_DISAPPEAR;
import static com.recycletest.recycleview.ViewInfoStore.InfoRecord.FLAG_APPEAR_PRE_AND_POST;
import static com.recycletest.recycleview.ViewInfoStore.InfoRecord.FLAG_DISAPPEARED;
import static com.recycletest.recycleview.ViewInfoStore.InfoRecord.FLAG_POST;
import static com.recycletest.recycleview.ViewInfoStore.InfoRecord.FLAG_PRE;
import static com.recycletest.recycleview.ViewInfoStore.InfoRecord.FLAG_PRE_AND_POST;
...
class ViewInfoStore {
    ...
    /**
     * Finds the ItemHolderInfo for the given ViewHolder in postLayout list and removes
     * it.
     * @param vh The ViewHolder whose information is being queried
     * @return The ItemHolderInfo for the given ViewHolder or null if it does not exist
     */
    ...
    /**
     * Adds the given ViewHolder to the appeared in pre layout list. These are Views added
     * by the LayoutManager during a pre-layout pass. We distinguish them from other views
     * that were already in the pre-layout so that ItemAnimator can choose to run a
     * different animation for them.
     * @param holder The ViewHolder to store
     * @param info The information to save
     */
    ...
    /**
     * Queries the oldChangeHolder list for the given key. If they are not tracked, simply
     * returns null.
     ...
     * This list holds such items so that we can animate / recycle these ViewHolders
     * properly.
