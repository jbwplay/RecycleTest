 ...
 * <p>
 * It wraps a RecyclerView and adds ability to hide some children. There are two sets of
 * methods provided by this class. <b>Regular</b> methods are the ones that replicate
 * ViewGroup methods like getChildAt, getChildCount etc. These methods ignore hidden
 * children.
 * <p>
 * When RecyclerView needs direct access to the view group children, it can call
 * unfiltered methods like get getUnfilteredChildCount or getUnfilteredChildAt.
 */
class ChildHelper {
     ...
     * @param child View to add.
     * @param index Index of the child from the regular perspective (excluding hidden
     * views). ChildHelper offsets this index to actual ViewGroup index.
     * @param hidden If set to true, this item will be invisible from regular methods.
     */
    ...
    /**
     * Moves a child view from hidden list to regular list. Calling this method should
     * probably be followed by a detach, otherwise, it will suddenly show up in
     * LayoutManager's children list.
    ...
    static class Bucket {
        ...
        @Override
        public String toString() {
            return mNext == null ? Long.toBinaryString(mData) : mNext.toString() + "xx" + Long
                    .toBinaryString(mData);
        }
    }
