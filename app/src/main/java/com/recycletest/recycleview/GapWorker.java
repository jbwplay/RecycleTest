...
final class GapWorker implements Runnable {
    ...
    /**
     * Temporary storage for prefetch Tasks that execute in {@link #prefetch(long)}. Task
     * objects are pooled in the ArrayList, and never removed to avoid allocations, but
     * always cleared in between calls.
     */
    ...
    private void flushTaskWithDeadline(Task task, long deadlineNs) {
        ...
        if (holder != null && holder.mNestedRecyclerView != null && holder.isBound() && !holder
                .isInvalid()) {
