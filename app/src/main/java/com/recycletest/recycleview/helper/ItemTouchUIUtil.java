...
/**
 * Utility class for {@link ItemTouchHelper} which handles item transformations for
 * different API versions.
 * <p/>
 * This class has methods that map to {@link ItemTouchHelper.Callback}'s drawing methods.
 * Default implementations in {@link ItemTouchHelper.Callback} call these methods with
 * {@link RecyclerView.ViewHolder#itemView} and {@link ItemTouchUIUtil} makes necessary
 * changes on the View depending on the API level. You can access the instance of {@link
 * ItemTouchUIUtil} via {@link ItemTouchHelper.Callback#getDefaultUIUtil()} and call its
 * methods with the children of ViewHolder that you want to apply default effects.
